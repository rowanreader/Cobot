...
mmesh.GetMesh().addTriangle(chrono.ChVectorD(-2, 1, 0), chrono.ChVectorD(-2, 1, 0.5), chrono.ChVectorD(-1, 1, 0))
# mmesh.SetStatic(False)
...
v1 = chrono.ChVectorD(0.0, 0.0, 0.0) + displ
