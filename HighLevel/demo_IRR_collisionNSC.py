...
def AddContainer(sys):
    ...
    ground.GetCollisionModel().AddBox(ground_mat, 60, 1, 60, chrono.ChVectorD(0, -20, 0))
    ground.GetCollisionModel().BuildModel()

    vshape = chrono.ChBoxShape()
    vshape.GetBoxGeometry().SetLengths(chrono.ChVectorD(60, 1, 60))
    vshape.GetBoxGeometry().Pos = chrono.ChVectorD(0, -20, 0)
    ground.AddAsset(vshape)
    ...
    mrigidBody.GetCollisionModel().AddBox(ground_mat, 1, 20, 20, chrono.ChVectorD(-11, 0, 0))
    mrigidBody.GetCollisionModel().AddBox(ground_mat, 1, 20, 20, chrono.ChVectorD(11, 0, 0))
    mrigidBody.GetCollisionModel().AddBox(ground_mat, 20, 20, 1, chrono.ChVectorD(0, 0, -11))
    mrigidBody.GetCollisionModel().AddBox(ground_mat, 20, 20, 1, chrono.ChVectorD(0, 0, 11))
    ...
    vshape.GetBoxGeometry().Pos = chrono.ChVectorD(0, -height, 0)
    mrigidBody.AddAsset(vshape)

    vshape = chrono.ChBoxShape()
    vshape.GetBoxGeometry().SetLengths(chrono.ChVectorD(1, 20, 20))
    vshape.GetBoxGeometry().Pos = chrono.ChVectorD(-11, -height/2, 0)
    mrigidBody.AddAsset(vshape)
    ...
    vshape = chrono.ChBoxShape()
    vshape.GetBoxGeometry().SetLengths(chrono.ChVectorD(20, 20, 1))
    vshape.GetBoxGeometry().Pos = chrono.ChVectorD(0, -height/2, -11)
    mrigidBody.AddAsset(vshape)
    ...
    rotatingBody = chrono.ChBodyEasyBox(10, 5, 1,  # x,y,z size
                                        ...
                                        True,  # collision?
                                        mixer_mat)  # contact material
    rotatingBody.SetPos(chrono.ChVectorD(0, -height/2, 0))
    sys.Add(rotatingBody)
